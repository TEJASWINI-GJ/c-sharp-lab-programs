...
namespace DB_demo2 {
    ...
    public partial class Database2DataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int Id, string Name_, string Branch, int Semester) {
...
namespace DB_demo2.Database2DataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name_ = 1 AND [Name ] IS NULL) OR ([Name ] = @Original_Name_)) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)) AND ((@IsNull_Semester = 1 AND [Semester] IS NULL) OR ([Semester] = @Original_Semester)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Id], [Name ], [Branch], [Semester]) VALUES (@Id, @N" +
                "ame_, @Branch, @Semester);\r\nSELECT Id, [Name ], Branch, Semester FROM Student WH" +
                "ERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Id] = @Id, [Name ] = @Name_, [Branch] = @Branch, [Semester] = @Semester WHERE (([Id] = @Original_Id) AND ((@IsNull_Name_ = 1 AND [Name ] IS NULL) OR ([Name ] = @Original_Name_)) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)) AND ((@IsNull_Semester = 1 AND [Semester] IS NULL) OR ([Semester] = @Original_Semester)));
SELECT Id, [Name ], Branch, Semester FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DB_demo2.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [Name ], Branch, Semester FROM dbo.Student";
        ...
        public virtual int Fill(Database2DataSet1.StudentDataTable dataTable) {
        ...
        public virtual Database2DataSet1.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database2DataSet1.StudentDataTable dataTable = new Database2DataSet1.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database2DataSet1.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name_, string Original_Branch, global::System.Nullable<int> Original_Semester) {
        ...
        public virtual int Insert(int Id, string Name_, string Branch, global::System.Nullable<int> Semester) {
        ...
        public virtual int Update(int Id, string Name_, string Branch, global::System.Nullable<int> Semester, int Original_Id, string Original_Name_, string Original_Branch, global::System.Nullable<int> Original_Semester) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name_, string Branch, global::System.Nullable<int> Semester, int Original_Id, string Original_Name_, string Original_Branch, global::System.Nullable<int> Original_Semester) {
            return this.Update(Original_Id, Name_, Branch, Semester, Original_Id, Original_Name_, Original_Branch, Original_Semester);
        }
    }
